...
class Constants:
    ...
    @classmethod
    def initialize(cls):
        cls.DOWNLOAD_FOLDER.mkdir(parents=True, exist_ok=True)
        cls.NGA_open_data_art.mkdir(parents=True, exist_ok=True)
        cls.NGA_FOLDER_RENAME_TO.mkdir(parents=True, exist_ok=True)

    @classmethod
    def print_paths(cls):
        """Print all path-related constants for debugging."""
